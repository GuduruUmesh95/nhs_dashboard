...
import { TrendingUp, ChevronDown, ChevronRight, Download } from 'lucide-react';
import * as XLSX from 'xlsx';
import { saveAs } from 'file-saver';

export default function WeeklyThroughputPage() {
  ...
  return (
    <div className="page-body fade-in">
      <div className="topbar">
        <div>
          <div className="topbar-title" style={{ display: 'flex', alignItems: 'center', gap: 8 }}><TrendingUp size={18} /> Weekly Application Throughput</div>
          <div className="topbar-subtitle">Week-on-week comparison of application volumes per organisation</div>
        </div>
