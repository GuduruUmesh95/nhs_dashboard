...
export default function MonthlyThroughputPage() {
  ...
  return (
    <div className="page-body fade-in">
      <div className="topbar">
        <div>
          <div className="topbar-title" style={{ display: 'flex', alignItems: 'center', gap: 8 }}><BarChart2 size={18} /> Monthly Application Throughput</div>
          <div className="topbar-subtitle">12-month rolling view of approvals by organisation</div>
        </div>
        <div className="topbar-right">
          <button className={`btn ${!viewChart ? 'btn-navy' : 'btn-outline'} btn-sm`} onClick={() => setViewChart(!viewChart)}>
      ...
      <div style={{ padding: 24 }}>
        ...
        {viewChart ? (
          <div className="card">
            <div className="card-header"><div className="card-title">Monthly Approvals (Filtered)</div></div>
